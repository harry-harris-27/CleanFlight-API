...
public enum MSPCode 
{
	...
	// Private variable
	private int codeByteValue;
	
	
	// Constructors
	private MSPCode(int b)
	{
		codeByteValue = b & BYTE_MASK;;
	}
	
	
	// Methods
	
	public static MSPCode valueOf(int i)
	{
		i &= 0xFF;
		
		for (MSPCode cmd : MSPCode.values())
		{
			if (cmd.codeByteValue == i)
			{
				return cmd;
			}
		}
		
		return MSPCode.Undefined;
	}
	
	public int value()
	{
		return codeByteValue;
	}
